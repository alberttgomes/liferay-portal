...
UpgradeJavaFetchCommerceAccountGroupByExternalReferenceCodeCheck | [Upgrade](upgrade_checks.markdown#upgrade-checks) | Replace method and reorder parameters on method `fetchCommerceAccountGroupByExternalReferenceCode` from `AccountGroupLocalService` |
